  ...
  <div class="preloader">
    ...
    <section class="insurance2">
        ...
        <section class="page-header">
            <div class="page-header__bg" style="background-image: url(assets/images/backgrounds/bgcomp2.jpg);height: 114%;background-position: revert-layer;">
            </div>
            <div class="container">
                <div class="page-header__inner">
                    <h2><?php echo $translations['HEADER_TITLE']; ?></h2>
                </div>
            </div>
        </section>
                ...
                <div class="row" style="margin-bottom: 9%;">
                    <div class="col-xl-12 col-lg-12">
                        <div class="contact-page__left">
                            <img class="imagecolab" src="assets/images/gallery/professionnels1.jpg" style="width: 500px; float: right; margin-left: 50px" alt="">
                            <h3 style="margin-top: -108px; font-weight: 700;font-size: 20pt; text-align:justify; color: #e73f23;"><?php echo $translations['AUDIT_TITLE']; ?></h3>
                            <p style="text-align:justify"><?php echo $translations['AUDIT_TEXT1']; ?></p>
                            <p style="text-align:justify; margin-top: 12px;"><?php echo $translations['AUDIT_TEXT2']; ?></p>
                            <p style="text-align:justify; margin-top: 12px;"><?php echo $translations['AUDIT_TEXT3']; ?></p>
                        </div>
                    </div>
                </div>
                <div class="insurance-details__need-help" style="margin-left: 60px;margin-right: 60px;margin-top: -94px;">
                    <div class="insurance-details__need-help-bg" style="background-image: url(assets/images/backgrounds/bgcomp4.jpg);"></div>
