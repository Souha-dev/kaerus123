...
?>
        ...
        <section class="blog-details">
            <div class="container">
                <div class="row">
                    <div class="col-xl-8 col-lg-7"style="margin-top: 55px;">
                        <div class="blog-details__left">
                            <div class="blog-details__img-1">
                                <img src="assets/images/gallery/man-saving-money-energy-crisis.jpeg" alt="">
                            </div>
                            <div class="blog-details__content">
                                <h3 class="blog-details__title-1">  </h3>
                              
                           
                            </div>
                        

                                <p  style="font-style: italic; text-align: justify;color:black; "><?php echo $translations['TAX_CHALLENGE_1']?></p>

                                 <p  style="font-style: italic; text-align: justify;color:black; "> <?php echo $translations['TAX_CHALLENGE_2']?></p>
                                    
                                  <p  style="font-style: italic; text-align: justify;color:black; "><?php echo $translations['TAX_CHALLENGE_3']?></p>
                                    
                                  <p  style="font-style: italic; text-align: justify;color:black; "><?php echo $translations['TAX_CHALLENGE_4']?></p>
                                    
                                  <p  style="font-style: italic; text-align: justify;color:black; ">  <?php echo $translations['TAX_CHALLENGE_5']?></p>
                                    
                                  <p  style="font-style: italic; text-align: justify;color:black; "> <?php echo $translations['TAX_CHALLENGE_6']?></p>
