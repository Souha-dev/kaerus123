...
<section class="insurance2">
        ...
        <section class="page-header">
            <div class="page-header__bg" style="background-image: url(assets/images/backgrounds/impotetax.jpg); height:98%;">
            </div>
            <div class="container">
                <div class="page-header__inner">
                    <h2>  <?php echo $translations['PAGE_HEADER_TITLE']?></h2>
                    <!-- <div class="thm-breadcrumb__box">
                        <ul class="thm-breadcrumb list-unstyled">
                            <li><a href="index.php">Accueil</a></li>
                            <li><span>-</span></li>
                            <li><a href="insurance.php">	Impôts & taxes </a></li>
                            <li><span>-</span></li>
...
<!--                            <h3 class="contact-page__title" style="margin-top: -15px;">Mot du président</h3>-->
<!--                            <p class="contact-page__text">-->
<!--                                Nous sommes un réseau de cabinets d’expertise-comptable et de commissariat aux comptes implanté dans le monde entier. Chacun des membres de notre réseau exerce donc une profession réglementée dans chacun des pays dans lequel il est implanté. Cette condition d’entré de nos membres dans le réseau KAERUS Global Finance est déterminante et vise à garantir à nos clients une déontologie, une réglementation et une haute qualité de service.</p>-->
                            <img class="imagecolab" src="assets/images/backgrounds/bgcomp6.jpg" style="width: 389px;
  float: right;
  margin-left: 37px;
  margin-top: 6px;" alt="">

                            <h3 style="margin-top: -108px;     font-weight: 700;font-size: 20pt;  text-align:justify;  color: #e73f23;"><?php echo $translations['IMPOTS_TAXES_TITLE']?></h3>

                           
  <p  style=" text-align:justify" ><?php echo $translations['IMPOTS_TAXES_DESC_1'] ?></p>
                              
                                
                              </p>
                              <p class="insurance-details__text-2" style="text-align:justify" >
                           <?php echo $translations['IMPOTS_TAXES_DESC_2']?>
                                </p>
