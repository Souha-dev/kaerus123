...
<body>
    ...
    <div class="page-wrapper">
        ...
        <section class="insurance2">
            ...
            <section class="page-header">
                <div class="page-header__bg" style="background-image: url(assets/images/backgrounds/bgcomp7.jpg);height:90%;">
                </div>
                <div class="container">
                    <div class="page-header__inner">
                        <h2><?php echo $translations['SERVICE_Collaboration']; ?></h2>
                    </div>
                </div>
            </section>
            <!-- Page Header End -->
    ...
    <div class="row1">
            ...
            <section class="insurance-details">
                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12">
                            <div class="contact-page__left">
                                <img class="imagecolab" src="assets/images/gallery/professionnels2.jpg" style="width: 500px; float: right; margin-left: 50px" alt="">

                                <h3 style="margin-top: -108px; font-weight: 700; font-size: 20pt; text-align:justify; color: #e73f23;"><?php echo $translations['COLLABORATION_TITLE']; ?></h3>

                                <p style="text-align: justify; margin: 5px 0"><?php echo $translations['COLLABORATION_TEXT1']; ?></p>
                                <p style="text-align: justify; margin: 5px 0"><?php echo $translations['COLLABORATION_TEXT2']; ?></p>
                ...
                <div class="insurance-details__need-help" style="margin-left: 60px; margin-right: 60px; margin-top: 36px;">
                    <div class="insurance-details__need-help-bg" style="background-image: url(assets/images/backgrounds/bgcomp4.jpg);">  
                    </div>
                    <h3 class="insurance-details__need-help-title"><?php echo $translations['REQUEST_SERVICE_TITLE']; ?></h3>
                    <div class="insurance-details__need-help-btn-box">
                        <a href="contact.php" class="insurance-details__need-help-btn thm-btn"><?php echo $translations['CONTACT_US']; ?></a>
                    </div>
                </div>
                ...
                <div class="insurance-details__contact" style="margin-top: 15px; margin: 58px;">
                    ...
                    <div class="insurance-details__contact-content">
                        <p><a class="contact" href="mailto:contact@kaerus.fr"><i class="fac fac-envelope"></i>contact@kaerus.global</a></p>
                    </div>
                </div>
            </section>
   ...
   ?>
    ...
    carouselCells.forEach(function(cell) {
        ...
        var backgroundColor;
        switch(href) {
            case "service-Conseil.php":
                backgroundColor = "#ABCDEF"; // Nouvelle couleur de fond pour le lien "service-Conseil.php"
                break;
            case "service-audit.php":
                backgroundColor = "#FEDCBA"; // Nouvelle couleur de fond pour le lien "service-audit.php"
                break;
            case "service-impot-taxes.php":
                backgroundColor = "#CBA987"; // Nouvelle couleur de fond pour le lien "service-impot-taxes.php"
                break;
            case "service-Collaborations.php":
                backgroundColor = "#765432"; // Nouvelle couleur de fond pour le lien "service-Collaborations.php"
                break;
            default:
