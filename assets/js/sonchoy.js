...
submitButton.addEventListener('click', () => {
  const form = document.querySelector('.comment-one__form');
  ...
  .then(data => {
    ...
    result.textContent = data; // Display success or error message
  })
  .catch(error => {
    console.error(error);
    const result = document.querySelector('.result');
    result.textContent = 'Une erreur est survenue.'; // Display error message
  });
});
